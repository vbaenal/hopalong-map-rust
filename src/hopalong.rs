...
impl Hopalong {
    pub fn random (&self, x_range: [f64; 2], y_range: [f64; 2], iterations: usize, n_points: usize) -> (Vec<Vec<f64>>, Vec<Vec<f64>>) {
    ...
    fn iterate (&self, mut xss: Vec<Vec<f64>>, mut yss: Vec<Vec<f64>>, iterations: usize, n_points: usize) -> (Vec<Vec<f64>>, Vec<Vec<f64>>) {
